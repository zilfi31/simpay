...
?>
    <h1 class="h3 font-weight-bold mb-2">Pengaturan Akun</h1>
        <!-- Profile widget -->
            ...
            <div class="px-4 bg-purple" style="border-radius:0.25rem;">
                <div class="media align-items-end profile-header">
                    ...
                    <div class="media-body mb-5">
                        <h4 class="user_name mt-0 "><?php echo $username; ?></h4>
                        <p class="small mb-4">Admin</p>
                    </div>
                </div>
            </div>

            <div class="setting py-4 px-4 mt-5">
            ...
            <form method="post">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 text-right mt-3">
                            <div id="Ada1">
                                <button type="button" class="btn_biru btn_efek px-4" onclick="GetVerif()">Update</button>
                            </div>
                            ...
                            <div class="tengah-tengah px-3">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" name="SimpanEdit" class="btn_biru btn_efek px-3">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="PagePassword" class="tab-pane fade"><br>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-md-11 col-lg-7 text-right">
                                <button type="submit" name="UpdatePass" class="btn_biru btn_efek px-4">Update</button>
                            </div>
                        </div>
